...
async function main() {
  ...
  //metadata index
  const CID = "QmRUjZjXrVQKKMESbdBXqjGgPcsba3SN2Uw84cUpn77Pt3";
  const ipfsIndex = "https://blush-bright-cobra-57.mypinata.cloud/ipfs";
  ...
  for (let i = 0; i < 3; i++) {
    const transaction = await realEstate
      .connect(seller)
      .mint(`${ipfsIndex}/${CID}/${i + 1}.json`);
    await transaction.wait();
  }

  console.log(`3 properties minted.\n`);
